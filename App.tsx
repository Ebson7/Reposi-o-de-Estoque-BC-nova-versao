...
const DEFAULT_VENDEDORES = [
  ...
  "DOUGLAS PITELLI", "EDMILSON LEAL", "FERNANDO APARECIDO", "GIAN CARLO DELVAZ",
  "GIANDERSON SARTORE", "GUSTAVO PAULINO", "JOAO JOSE", "JOAO MANUEL",
  "JURACI SEBASTIÃO DOS REIS", "LEANDRO CAETANO MAFORT", "LEANDRO DA SILVA GREGIO",
  "LEONARDO APARECIDO", "LUIS ALEXANDRE", "MARCELO SANTOS", "MARCO AURELIO",
  "MARCO AURELIO MARTINS FILHO", "NIVALDO NEVES", "ROSIMAR FREITAS",
  "ROZIMARA SOUZA", "TELMA CRISTINA", "VALDINEI DA SILVA PEREIRA",
  "WASHINGTON BELMIRO", "OUTRO"
];
